...
namespace MsSqlClientTools
{
    public static class MsSqlClientTools
    {
        public static string ConnectionString = @"Data Source=LAPTOP-S81VJ7MF\MSSQLSERVER01;Initial Catalog=Расчет;Integrated Security=True";
...
User ID: логин пользователя
        ...
        public static string[,] ResultAsStringArray;

        public static string ConnectToDb(string login, string password)
        {
            string curConnect = ConnectionString;///Создаём текущую строку подключения
        ...
        public static DataView GenerateTables(string[,] Data)//Преобразовываем в DataGrid
        {
            if (Data != null)
            {
